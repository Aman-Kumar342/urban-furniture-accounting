...
// Structure per the Excalidraw Forgot Password page: App Logo -> Email -> Submit -> back to Login.
    ...
    >
      <div className="w-full max-w-[400px]">
        <div className="rounded-xl border border-line bg-surface px-8 py-9 shadow-[0_1px_2px_rgba(33,28,24,0.05),0_10px_28px_-14px_rgba(33,28,24,0.14)]">
          ...
          <h1 className="mt-7 text-center font-display text-xl text-ink">Reset your password</h1>
